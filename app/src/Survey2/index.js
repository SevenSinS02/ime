            ...
            <div className="sixteen wide column" style={{ padding: 0 }}>
              ...
              >
                ...
                <h1 className={`ui inverted header ${styles.surveyQuestion}`}>
                  Who should have the maximunm rights over a piece of music, and
                  consequently get a lion's share of the proceeds?
                </h1>
                <Chart chartHandler={this.chartHandler} />
              </div>
